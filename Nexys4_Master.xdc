...
set_property PACKAGE_PIN L3 [get_ports {S[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {S[0]}]
##Bank = 34, Pin name = IO_L3N_T0_DQS_34,					Sch name = CB
set_property PACKAGE_PIN N1 [get_ports {S[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {S[1]}]
##Bank = 34, Pin name = IO_L6N_T0_VREF_34,					Sch name = CC
set_property PACKAGE_PIN L5 [get_ports {S[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {S[2]}]
##Bank = 34, Pin name = IO_L5N_T0_34,						Sch name = CD
set_property PACKAGE_PIN L4 [get_ports {S[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {S[3]}]
##Bank = 34, Pin name = IO_L2P_T0_34,						Sch name = CE
set_property PACKAGE_PIN K3 [get_ports {S[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {S[4]}]
##Bank = 34, Pin name = IO_L4N_T0_34,						Sch name = CF
set_property PACKAGE_PIN M2 [get_ports {S[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {S[5]}]
##Bank = 34, Pin name = IO_L6P_T0_34,						Sch name = CG
set_property PACKAGE_PIN L6 [get_ports {S[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {S[6]}]

##Bank = 34, Pin name = IO_L16P_T2_34,						Sch name = DP
set_property PACKAGE_PIN M4 [get_ports {S[7]}]
...
#set_property PACKAGE_PIN E16 [get_ports b_ctr]
#set_property IOSTANDARD LVCMOS33 [get_ports b_ctr]
#Bank = 15, Pin name = IO_L14P_T2_SRCC_15,					Sch name = BTNU
set_property PACKAGE_PIN F15 [get_ports cmd_up]
set_property IOSTANDARD LVCMOS33 [get_ports cmd_up]
#Bank = CONFIG, Pin name = IO_L15N_T2_DQS_DOUT_CSO_B_14,	Sch name = BTNL
#set_property PACKAGE_PIN T16 [get_ports b_left]
#set_property IOSTANDARD LVCMOS33 [get_ports b_left]
##Bank = 14, Pin name = IO_25_14,							Sch name = BTNR
#set_property PACKAGE_PIN R10 [get_ports b_right]
#set_property IOSTANDARD LVCMOS33 [get_ports b_right]
#Bank = 14, Pin name = IO_L21P_T3_DQS_14,					Sch name = BTND
set_property PACKAGE_PIN V10 [get_ports cmd_down]
set_property IOSTANDARD LVCMOS33 [get_ports cmd_down]



##Pmod Header JA
##Bank = 15, Pin name = IO_L1N_T0_AD0N_15,					Sch name = JA1
#set_property PACKAGE_PIN B13 [get_ports {wave[3]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {wave[3]}]
##Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = JA2
#set_property PACKAGE_PIN F14 [get_ports {wave[2]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {wave[2]}]
##Bank = 15, Pin name = IO_L16N_T2_A27_15,					Sch name = JA3
#set_property PACKAGE_PIN D17 [get_ports {wave[1]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {wave[1]}]
##Bank = 15, Pin name = IO_L16P_T2_A28_15,					Sch name = JA4
#set_property PACKAGE_PIN E17 [get_ports {wave[0]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {wave[0]}]

#AMODIF
##Bank = 15, Pin name = IO_0_15,								Sch name = JA7
#set_property PACKAGE_PIN G13 [get_ports {wave[7]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {wave[7]}]
##Bank = 15, Pin name = IO_L20N_T3_A19_15,					Sch name = JA8
#set_property PACKAGE_PIN C17 [get_ports {wave[6]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {wave[6]}]
##Bank = 15, Pin name = IO_L21N_T3_A17_15,					Sch name = JA9
#set_property PACKAGE_PIN D18 [get_ports {wave[5]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {wave[5]}]
##Bank = 15, Pin name = IO_L21P_T3_DQS_15,					Sch name = JA10
#set_property PACKAGE_PIN E18 [get_ports {wave[4]}]
